...
#ifndef BOOST_ACTOR_DETAIL_TYPE_TRAITS_HPP
#define BOOST_ACTOR_DETAIL_TYPE_TRAITS_HPP
...
// either a `boost::actor::serializer` or `boost::actor::deserializer` as first argument
template <class T>
...
#endif // BOOST_ACTOR_DETAIL_TYPE_TRAITS_HPP
