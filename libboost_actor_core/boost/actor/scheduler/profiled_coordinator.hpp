...
#ifndef BOOST_ACTOR_SCHEDULER_PROFILED_COORDINATOR_HPP
#define BOOST_ACTOR_SCHEDULER_PROFILED_COORDINATOR_HPP

#include "boost/actor/config.hpp"

#if defined(BOOST_ACTOR_MACOS) || defined(BOOST_ACTOR_IOS)
#include <mach/mach.h>
#else
...
#include "boost/actor/policy/profiled.hpp"
...
#     endif // BOOST_ACTOR_MACOS
  ...
  void stop_measuring(size_t worker, actor_id job) {
    ...
    auto& w = worker_states_[worker];
    BOOST_ACTOR_ASSERT(job == w.current);
    auto delta = m - w.job;
...
#endif // BOOST_ACTOR_SCHEDULER_PROFILED_COORDINATOR_HPP
