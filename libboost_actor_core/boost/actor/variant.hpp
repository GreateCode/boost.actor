...
#ifndef BOOST_ACTOR_VARIANT_HPP
#define BOOST_ACTOR_VARIANT_HPP

#include "boost/actor/static_visitor.hpp"

#include "boost/actor/detail/type_list.hpp"
#include "boost/actor/detail/type_traits.hpp"
#include "boost/actor/detail/variant_data.hpp"

#define BOOST_ACTOR_VARIANT_CASE(x)                                                    \
  case x:                                                                      \
...
private:
  ...
  static typename Visitor::result_type  apply_impl(Self& from, Visitor& visitor) {
    switch (from.type_) {
      ...
      BOOST_ACTOR_VARIANT_CASE(0);
      BOOST_ACTOR_VARIANT_CASE(1);
      BOOST_ACTOR_VARIANT_CASE(2);
      BOOST_ACTOR_VARIANT_CASE(3);
      BOOST_ACTOR_VARIANT_CASE(4);
      BOOST_ACTOR_VARIANT_CASE(5);
      BOOST_ACTOR_VARIANT_CASE(6);
      BOOST_ACTOR_VARIANT_CASE(7);
      BOOST_ACTOR_VARIANT_CASE(8);
      BOOST_ACTOR_VARIANT_CASE(9);
      BOOST_ACTOR_VARIANT_CASE(10);
      BOOST_ACTOR_VARIANT_CASE(11);
      BOOST_ACTOR_VARIANT_CASE(12);
      BOOST_ACTOR_VARIANT_CASE(13);
      BOOST_ACTOR_VARIANT_CASE(14);
      BOOST_ACTOR_VARIANT_CASE(15);
      BOOST_ACTOR_VARIANT_CASE(16);
      BOOST_ACTOR_VARIANT_CASE(17);
      BOOST_ACTOR_VARIANT_CASE(18);
      BOOST_ACTOR_VARIANT_CASE(19);
      BOOST_ACTOR_VARIANT_CASE(20);
    }
  }
