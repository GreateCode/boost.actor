...
#define BOOST_TEST_MODULE io_http_broker
...
using http_broker = boost::actor::stateful_actor<http_state, broker>;
...
public:
  ...
  public:
    ...
    mock_t& expect(const std::string& x) {
      ...
      BOOST_REQUIRE((std::equal(buf.begin(),
